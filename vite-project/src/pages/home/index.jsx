...
// import { OrbitControls, Environment, Html, Stats, OrthographicCamera } from '@react-three/drei'
...
//               <text x="12" y="22" fill="white" fontSize={30} fontFamily="monospace" style={{ pointerEvents: 'none' }}>
//                 {i + 1}
//               </text>
//             </svg>
...
//   <Wrapper>
//     <Suspense fallback={null}>
//       <Canvas className="canvas" camera={{ position: [8, 2, 12] }} onPointerDown={() => setLerping(false)} onWheel={() => setLerping(false)}>
